    ...
    if request.method == 'GET':
        ...
        for cat in initcats:
            ...
            for subcat in InitSubCat.objects.filter(initcat=cat):
                subcats.append({'cat': subcat.initcat.cat_text, 'subcat':subcat.subcat_text, 'description':subcat.subcat_description, 'pk':subcat.pk, 'catpk':subcat.initcat.pk, 'show': False})
        response = {
            'cats': cats,
            'subcats': subcats
        }
